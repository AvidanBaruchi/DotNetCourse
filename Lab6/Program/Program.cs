    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!done)
            {
                ...
                catch (ArgumentOutOfRangeException argumentsException)
                {
                    Console.WriteLine("Wrong Input: {0}", argumentsException.Message);
                }
                catch(InsufficientFundsException fundsException)
                {
                    Console.WriteLine("Insufficient Funds: {0}", fundsException.Message);
                } 
            }
            ...
            {
                Console.WriteLine();
                Console.WriteLine("Test The Transfer Finally Block");
                a2.Transfer(a3, 300000000);
            }
